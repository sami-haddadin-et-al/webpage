+++
title = "A tool for the evaluation of human lower arm injury: approach, experimental validation and application to safe robotics"
date = "2016-01-01"
categories = ["publication", "article"]
tags = ["publication", "article"]
author = ["Borut Povse", "Sami Haddadin", "Rico Belder", "Darko Koritnik", "Tadej Bajd"]
keywords = []
draft = false
gen_lock = false
+++
