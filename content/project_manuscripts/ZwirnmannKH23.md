...
author = ["Henning Zwirnmann", "Dennis Knobbe", "Sami Haddadin"]
keywords = []
draft = false
gen_lock = false
+++

# TTowards End-to-End Automated Microscopy Control using Holotomography: Workflow Design and Data Management
